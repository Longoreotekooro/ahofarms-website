...
export const PORTALS = [
  {
    ...
    support: { email: 'admin@ahofarms.com', label: 'Prescriber support' },
  ...
  },
  {
    ...
    support: { email: 'admin@ahofarms.com', label: 'Supply enquiries' },
  ...
  },
  {
    ...
    support: { email: 'admin@ahofarms.com', label: 'International supply' },
...
export const CONSUMER = {
  ...
  support: { email: 'admin@ahofarms.com', label: 'General enquiries' },
};
