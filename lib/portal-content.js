...
// RĀ · Oreo (product sheet supplied 2026-09-22). Values are nominal; the
// batch Certificate of Analysis carries verified results.
const RA_OREO = {
  title: 'RĀ · Oreo',
  meta: 'Indica-dominant hybrid · Dried flower · 10 g',
  note: 'Cookies & Cream lineage. Rich, creamy profile with sweet vanilla and chocolate-cookie notes over earthy, dessert-like undertones. Grown in living soil in Hawke\'s Bay; GMP-aligned with full batch traceability.',
  specs: [['THC', '20%'], ['CBD', '1%'], ['Genetics', 'Indica'], ['Lineage', 'Cookies & Cream'], ['Format', 'Dried flower'], ['Pack', '10 g'],
          ['Dominant terpenes (mg/g)', 'β-Caryophyllene 3.2 · δ-Limonene 2.4 · α-Humulene 1.1 · Guaiol 0.8 · Linalool 0.7'],
          ['Storage', 'Below 25°C in original packaging, away from light and moisture'], ['Testing', 'GMP-aligned; CoA available per batch']],
  status: 'available', href: '/portal/pharmacy/files/ra-oreo-product-sheet.pdf', kind: 'product', action: 'Product sheet (PDF)',
};
  ...
  pharmacy: {
    ...
    sections: [
      ...
      { id: 'documents', nav: 'Documents', eyebrow: '03 · Documentation', title: 'Certificates and product documentation', lead: 'Batch documentation for dispensing and record-keeping.',
        items: [
          coming('Certificates of Analysis', 'Independent laboratory certificates by batch, downloadable as PDF.', 'document'),
          live('RĀ · Oreo product sheet', 'Two-page cultivar sheet: specification, terpene profile, preparation, storage, testing and batch traceability.', '/portal/pharmacy/files/ra-oreo-product-sheet.pdf', { action: 'Open PDF' }),
